...
void MyWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->isMouseOnWindow((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (MyWidget::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyWidget::isMouseOnWindow)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void MyWidget::isMouseOnWindow(bool _t1)
{
